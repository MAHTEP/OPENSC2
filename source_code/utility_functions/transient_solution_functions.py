...
def step(conductor, environment, qsource, num_step):
    ...
    XMED = (
        np.array(
            conductor.grid_features["xcoord"][:-1]
            + conductor.grid_features["xcoord"][1:]
        )
        / 2.0
    )
    conductor.grid_features["Delta_x"] = (
        conductor.grid_features["xcoord"][1:]
        - conductor.grid_features["xcoord"][:-1]
    )
    ...
    for ii in range(conductor.gird_input["NELEMS"]):
        ...
        for jj, fluid_comp_j in enumerate(conductor.inventory["FluidComponent"].collection):
            ...
            KMAT[jj, jj] = (
                conductor.grid_features["Delta_x"][ii]
                * UPWEQT[jj]
        ...
        ELMMAT[
            ...
            0 : conductor.dict_N_equation["NODOFS"],
        ] = (conductor.grid_features["Delta_x"][ii] * (1.0 / 3.0 + ALFA) * MMAT)
        ELMMAT[
            0 : conductor.dict_N_equation["NODOFS"],
            conductor.dict_N_equation["NODOFS"] : 2
            * conductor.dict_N_equation["NODOFS"],
        ] = (conductor.grid_features["Delta_x"][ii] * (1.0 / 6.0 - ALFA) * MMAT)
        ELMMAT[
            conductor.dict_N_equation["NODOFS"] : 2
            * conductor.dict_N_equation["NODOFS"],
            0 : conductor.dict_N_equation["NODOFS"],
        ...
        ELKMAT[
            0 : conductor.dict_N_equation["NODOFS"],
            0 : conductor.dict_N_equation["NODOFS"],
        ] = (KMAT / conductor.grid_features["Delta_x"][ii])
        ELKMAT[
            0 : conductor.dict_N_equation["NODOFS"],
            conductor.dict_N_equation["NODOFS"] : 2
            * conductor.dict_N_equation["NODOFS"],
        ...
        ELSMAT[
            0 : conductor.dict_N_equation["NODOFS"],
            0 : conductor.dict_N_equation["NODOFS"],
        ] = (SMAT * conductor.grid_features["Delta_x"][ii] / 3.0)
        ELSMAT[
            0 : conductor.dict_N_equation["NODOFS"],
            conductor.dict_N_equation["NODOFS"] : 2
            * conductor.dict_N_equation["NODOFS"],
        ] = (SMAT * conductor.grid_features["Delta_x"][ii] / 6.0)
        ELSMAT[
            conductor.dict_N_equation["NODOFS"] : 2
            * conductor.dict_N_equation["NODOFS"],
            0 : conductor.dict_N_equation["NODOFS"],
